...
const CLINIC = {
  ...
  /* ---------- PROGRAMMATIC SEO ----------
     Generates one landing page per treatment × area, from the data
     already in treatments.js. Run: node seo-generate.js
     Keep this list SHORT and the copy REAL — see the warning at the
     top of seo-generate.js. Twelve pages that deserve to rank beat
     fifty that read as spam.                                        */
  seo: {
    enabled: true,
    siteUrl: "https://imsal007.github.io/clinic-os-demo",
    outDir:  "find",

    // Only the treatments people actually search for by name.
    treatments: ["wrinkle-three", "lip-filler", "cheek-filler", "chemical-peel"],

    // Write genuine copy per area. Do not template this.
    areas: [
      { name: "Shoreditch",
        blurb: "The clinic is on Redchurch Street, a two-minute walk from the Boxpark end of Bethnal Green Road. Most Shoreditch clients walk in on their lunch break.",
        travel: "Nearest station is Shoreditch High Street (Overground), four minutes on foot. Old Street is a ten-minute walk." },
      { name: "Bethnal Green",
        blurb: "Bethnal Green clients are usually here in under fifteen minutes — straight down Bethnal Green Road and left at the top.",
        travel: "Bethnal Green (Central line) is one stop, or a twenty-minute walk. The 8 bus stops at the end of the road." },
      { name: "Hackney",
        blurb: "A steady share of the clinic's regulars come down from Hackney Central and London Fields, most often for the evening slots.",
        travel: "Hackney Central to Shoreditch High Street is two stops on the Overground. Parking on Redchurch Street is metered and limited — the train is easier." },
      { name: "Islington",
